...
#include "Lier.h"
#include <iostream>
Lier::Lier(const Tile* tile, std::list <sf::Vector2i> list) :Bulding(tile), numberWaves(3), beginTime(sf::Time::Zero), checkPoints(list), numberWave(0), cooldownWave(sf::seconds(5.f))
{
	generateWave();
}
